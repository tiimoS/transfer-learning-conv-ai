...
HF_FINETUNED_MODEL = "../models_finetuned/fine-tuned-model.tar.gz"         # TODO add for retraining
...
def download_pretrained_model():
    ...
    return tempdir + '/output'  # TODO add for retraining
...
def get_dataset(tokenizer, dataset_path, dataset_cache=None):
    ...
    if dataset_cache and os.path.isfile(dataset_cache):
        ...
        training_dataset_file = cached_path(dataset_path)
